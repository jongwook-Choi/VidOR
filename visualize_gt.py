...
if __name__ == '__main__':
    ...
    output_dir = "./outputs/visualize_json/gt"
    video_name = folder_name.split('/')[1].split('.')[0]
    video_name = '{}.avi'.format(video_name)
    video_path = os.path.join(output_dir, video_name)
    #anno_dir = "/media/ailab/4f12b7e1-629d-424c-8fe5-35a9c2f8db76/jonghun/workspace/vidvrd/vidor-dataset"
    anno_dir = './vidor-dataset'
    mode = "training"
    anno_dir = os.path.join(anno_dir, mode)
