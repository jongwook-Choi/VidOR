...
if __name__ == '__main__':
    prediction_json_file = './outputs/eval_json/eval_tracklet.json.xz'
    ...
    parser.add_argument('--split', choices=['validation', 'test'], help='the split name for evaluation', default='validation')
